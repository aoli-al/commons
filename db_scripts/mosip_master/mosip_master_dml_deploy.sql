...
\COPY master.machine_master (id,name,mac_address,serial_num,ip_address,mspec_id,public_key,key_index,zone_code,regcntr_id,lang_code,is_active,cr_by,cr_dtimes,sign_public_key,sign_key_index) FROM './dml/master-machine_master.csv' delimiter ',' HEADER  csv;
